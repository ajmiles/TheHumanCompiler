...
const VOP1_OPCODES: OpcodeInfo[] = [
  ...
  },
  {
    ...
    opcode: 0x0C,
    operandCount: 2,
    execute: (a) => Math.floor(a + 0.5),
    description: 'Convert f32 to i32 with round-to-positive-infinity (round half up).\nvdst = (i32)round(src0)',
  ...
  },
  {
    ...
    opcode: 0x0D,
    operandCount: 2,
    execute: (a) => Math.floor(a),
    description: 'Convert f32 to i32 with floor (round toward negative infinity).\nvdst = (i32)floor(src0)',
  ...
  },
  {
    ...
    execute: (a) => {
      const i4 = a & 0xF;
      return i4 >= 8 ? i4 - 16 : i4;
    },
    description: 'Convert signed 4-bit integer to f32 offset.\nvdst = (f32)(signed_4bit(src0[3:0]))',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => 1.0 / a,
    description: 'Reciprocal with IEEE flag reporting.\nvdst = 1.0 / src0',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Move to VGPR with relative destination.\nv[vdst + M0] = src0',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Move from VGPR with relative source.\nvdst = v[vsrc0 + M0]',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Move with relative source and destination.\nv[vdst + M0] = v[vsrc0 + M0]',
    syntax: 'v_movrelsd_b32 vdst, vsrc0',
    isIntegerOp: true,
  },
  {
    mnemonic: 'v_movrelsd_2_b32',
    format: InstructionFormat.VOP1,
    opcode: 0x48,
    operandCount: 2,
    execute: (a) => a,
    description: 'Move with relative source (M0) and relative destination (M0+1).\nv[vdst + M0 + 1] = v[vsrc0 + M0]',
    syntax: 'v_movrelsd_2_b32 vdst, vsrc0',
    isIntegerOp: true,
  },
  {
...
const SOP1_OPCODES: OpcodeInfo[] = [
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Conditional move: if SCC==1, sdst = ssrc0; else sdst unchanged.\nsdst = SCC ? ssrc0 : sdst',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Conditional move 64-bit: if SCC==1, sdst = ssrc0; else sdst unchanged.\nsdst = SCC ? ssrc0 : sdst',
    syntax: 's_cmov_b64 sdst, ssrc0',
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Move from SGPR with relative source.\nsdst = s[ssrc0 + M0]',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Move from SGPR pair with relative source (64-bit).\nsdst = s[ssrc0 + M0]',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Move to SGPR with relative destination.\ns[sdst + M0] = ssrc0',
  ...
  },
  {
    ...
    operandCount: 2,
    execute: (a) => a,
    description: 'Move to SGPR pair with relative destination (64-bit).\ns[sdst + M0] = ssrc0',
...
const SOP2_OPCODES: OpcodeInfo[] = [
  ...
  { mnemonic: 's_sub_i32', format: InstructionFormat.SOP2, opcode: 0x03, operandCount: 3, execute: (a, b) => (a - (b ?? 0)) | 0, description: 'Scalar subtract signed 32-bit.\nsdst = ssrc0 - ssrc1', syntax: 's_sub_i32 sdst, ssrc0, ssrc1' },
  ...
  { mnemonic: 's_cselect_b64', format: InstructionFormat.SOP2, opcode: 0x0B, operandCount: 3, execute: (a, _b) => a, description: 'Scalar conditional select 64-bit based on SCC.\nsdst = SCC ? ssrc0 : ssrc1', syntax: 's_cselect_b64 sdst, ssrc0, ssrc1' },
...
const SOPC_OPCODES: OpcodeInfo[] = [
  ...
  { mnemonic: 's_bitcmp0_b32', format: InstructionFormat.SOPC, opcode: 0x0C, operandCount: 2, execute: (a, b) => (((a >>> ((b ?? 0) & 31)) & 1) === 0) ? 1 : 0, description: 'Test if bit N of ssrc0 is zero. Sets SCC.\nSCC = (ssrc0[ssrc1[4:0]] == 0)', syntax: 's_bitcmp0_b32 ssrc0, ssrc1' },
  { mnemonic: 's_bitcmp1_b32', format: InstructionFormat.SOPC, opcode: 0x0D, operandCount: 2, execute: (a, b) => (((a >>> ((b ?? 0) & 31)) & 1) === 1) ? 1 : 0, description: 'Test if bit N of ssrc0 is one. Sets SCC.\nSCC = (ssrc0[ssrc1[4:0]] == 1)', syntax: 's_bitcmp1_b32 ssrc0, ssrc1' },
  { mnemonic: 's_bitcmp0_b64', format: InstructionFormat.SOPC, opcode: 0x0E, operandCount: 2, execute: (a, b) => (((a >>> ((b ?? 0) & 63)) & 1) === 0) ? 1 : 0, description: 'Test if bit N of ssrc0 is zero (64-bit, low 32 bits). Sets SCC.\nSCC = (ssrc0[ssrc1[5:0]] == 0)', syntax: 's_bitcmp0_b64 ssrc0, ssrc1' },
  { mnemonic: 's_bitcmp1_b64', format: InstructionFormat.SOPC, opcode: 0x0F, operandCount: 2, execute: (a, b) => (((a >>> ((b ?? 0) & 63)) & 1) === 1) ? 1 : 0, description: 'Test if bit N of ssrc0 is one (64-bit, low 32 bits). Sets SCC.\nSCC = (ssrc0[ssrc1[5:0]] == 1)', syntax: 's_bitcmp1_b64 ssrc0, ssrc1' },
  { mnemonic: 's_cmp_eq_u64', format: InstructionFormat.SOPC, opcode: 0x10, operandCount: 2, execute: (a, b) => ((a >>> 0) === ((b ?? 0) >>> 0)) ? 1 : 0, description: 'Scalar compare equal unsigned 64-bit (low 32 bits). Sets SCC.\nSCC = (ssrc0 == ssrc1)', syntax: 's_cmp_eq_u64 ssrc0, ssrc1' },
];
