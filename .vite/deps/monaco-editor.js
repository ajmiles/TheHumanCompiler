import { a as MarkerSeverity, c as Range, d as Token, f as Uri, g as __exportAll, h as languages, i as KeyMod, l as Selection, m as editor_api2_exports, n as Emitter, o as MarkerTag, p as editor, r as KeyCode, s as Position, t as CancellationTokenSource, u as SelectionDirection } from "./editor.api2-C4idDwRp.js";
import { t as monaco_contribution_exports$3 } from "./monaco.contribution-akyeGXpt.js";
import { t as createWebWorker } from "./workers-Qq8Z-bnL.js";
import "J:/HumanCompiler/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon.css";
import "J:/HumanCompiler/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon-modifiers.css";
...
function getMode$2() {
	return import("./cssMode-B84OWhcd.js");
}
...
function getMode$1() {
	return import("./htmlMode-BYRdapCj.js");
}
...
function getMode() {
	return import("./jsonMode-Cwz-crxQ.js");
}
languages.register({
	id: "json",
	extensions: [
...
registerLanguage({
	...
	extensions: [".abap"],
	aliases: ["abap", "ABAP"],
	loader: () => import("./abap-m8s-volL.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./apex-vaqZO4Uy.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./azcli-C_hYBeAg.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".bicep"],
	aliases: ["Bicep"],
	loader: () => import("./bicep-B-_Z-8r7.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".mligo"],
	aliases: ["Cameligo"],
	loader: () => import("./cameligo-Dvitk-at.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./clojure-CYOTnFle.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./coffee-ButXtRJ5.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["C#", "csharp"],
	loader: () => import("./csharp-BvOIVTde.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./cypher-DhwUiEdG.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./dart-ftXKJLmU.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Dockerfile"],
	loader: () => import("./dockerfile-BT3Ska6h.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./elixir-BfWcYP-m.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./flow9-CP-LEQHI.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./fsharp-BPMGJaMz.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-DjLQPBS_.js").then((m) => m.TagAutoInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-DjLQPBS_.js").then((m) => m.TagAngleInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-DjLQPBS_.js").then((m) => m.TagBracketInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-DjLQPBS_.js").then((m) => m.TagAngleInterpolationBracket);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-DjLQPBS_.js").then((m) => m.TagBracketInterpolationBracket);
	}
});
registerLanguage({
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-DjLQPBS_.js").then((m) => m.TagAutoInterpolationBracket);
	}
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./graphql-BQ3iWzdz.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./handlebars-DXZr5A5L.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./html-CIOxUODi.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./java-Dy7oOCl1.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./javascript-Cv1Ktonx.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".jl"],
	aliases: ["julia", "Julia"],
	loader: () => import("./julia-C7gFE-Ln.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./kotlin-tj59g5Fz.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./less-BIEN9_UX.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".lex"],
	aliases: ["Lexon"],
	loader: () => import("./lexon-CzKOgbKJ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./liquid-B4JTvEF4.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./markdown-So_N6i0Z.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./mips-IawqwGqA.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["DAX", "MSDAX"],
	loader: () => import("./msdax-CDSxEbBp.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [],
	aliases: ["MySQL", "mysql"],
	loader: () => import("./mysql-DMsRmxad.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".m"],
	aliases: ["Objective-C"],
	loader: () => import("./objective-c-CNHFvRjE.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascal-Dt1qMiU0.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascaligo-B7Cj5EeO.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".pl", ".pm"],
	aliases: ["Perl", "pl"],
	loader: () => import("./perl-CZmO2r3f.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pgsql-Cbt_u8sx.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./postiats-BLkY1Vv9.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powerquery-CD2aW9Wu.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powershell-DBqSbid8.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./protobuf-DD3UDWj1.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./python-DMqU048g.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".qs"],
	aliases: ["Q#", "qsharp"],
	loader: () => import("./qsharp-DTKHM7Hh.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./razor-DnRdHa3b.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".redis"],
	aliases: ["redis"],
	loader: () => import("./redis-DVz3vl4p.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./redshift-Dvsw4jjQ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./restructuredtext-OGb6rNBH.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Ruby", "rb"],
	loader: () => import("./ruby-BqiQPWH2.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".rs", ".rlib"],
	aliases: ["Rust", "rust"],
	loader: () => import("./rust-QCqlLuDV.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scala-RNuVCVMx.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scheme-Bih5itNB.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scss-SBZcEGSY.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".sh", ".bash"],
	aliases: ["Shell", "sh"],
	loader: () => import("./shell-Djj62HuO.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./solidity-DgPI4XEE.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sophia--QS2lJXF.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sparql-DCoPSQES.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./swift-DESZUalg.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./systemverilog-lrL0Z8Qg.js")
});
registerLanguage({
	id: "verilog",
	extensions: [".v", ".vh"],
...
registerLanguage({
	...
	loader: () => import("./twig-BnhgBfBq.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./typescript-DgR6vhTC.js");
	}
});
//#endregion
...
registerLanguage({
	...
	extensions: [".tsp"],
	aliases: ["TypeSpec"],
	loader: () => import("./typespec-C-HdsK8z.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./wgsl-BsGaJkRL.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./yaml-EO0mHGHc.js")
});
//#endregion
