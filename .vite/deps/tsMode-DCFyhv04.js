import { a as MarkerSeverity, c as Range, f as Uri, h as languages, o as MarkerTag, p as editor } from "./editor.api2-C4idDwRp.js";
import { n as typescriptDefaults } from "./monaco.contribution-akyeGXpt.js";
	...
	_getClient() {
		if (!this._client) this._client = (async () => {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL("../../node_modules/monaco-editor/esm/vs/language/typescript/ts.worker.js", import.meta.url), { type: "module" }),
				label: this._modeId,
				keepIdleModels: true,
				createData: {
...
//# sourceMappingURL=tsMode-DCFyhv04.js.map