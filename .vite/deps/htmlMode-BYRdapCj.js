import { h as languages } from "./editor.api2-C4idDwRp.js";
	...
	_getClient() {
		...
		if (!this._client) {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL("../../node_modules/monaco-editor/esm/vs/language/html/html.worker.js", import.meta.url), { type: "module" }),
				createData: {
...
//# sourceMappingURL=htmlMode-BYRdapCj.js.map